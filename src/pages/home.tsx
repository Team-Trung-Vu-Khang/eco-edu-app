    ...
    <div className="flex flex-col items-center">
      ...
      <section className="w-full px-6 py-24 md:py-32 flex flex-col items-center text-center max-w-5xl mx-auto">
        <motion.div
          ...
          className="mb-8"
        >
          <img src="/mevi-logo.jpeg" alt="MEVI Logo" className="h-24 w-24 rounded-2xl object-contain shadow-sm border border-border" />
        </motion.div>
        <motion.div
        ...
        >
          A complete component system for modern agricultural platforms. Grounded design, purposeful interactions, and robust data display for the farming community.
        </motion.p>
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          ...
          <div className="grid gap-12 sm:grid-cols-3">
            ...
            >
              ...
              <p className="text-muted-foreground">
                Robust input controls designed specifically for complex agricultural data entry.
              </p>
            </motion.div>
            <motion.div 
              initial={{ opacity: 0, y: 20 }}
            ...
            >
              ...
              <p className="text-muted-foreground">
                Intuitive date pickers and calendars to keep operations running smoothly.
              </p>
            </motion.div>
            <motion.div 
              initial={{ opacity: 0, y: 20 }}
            ...
            >
              ...
              <p className="text-muted-foreground">
                Clear, actionable data visualizations to monitor yield and efficiency.
              </p>
            </motion.div>
          </div>
        </div>
